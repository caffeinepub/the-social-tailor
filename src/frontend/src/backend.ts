...
export class Backend implements backendInterface {
    ...
    async getAllAuditRequestsSortedNewestFirst(): Promise<Array<AuditRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAuditRequestsSortedNewestFirst();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllContactMessagesSortedNewestFirst(): Promise<Array<ContactSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactMessagesSortedNewestFirst();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAuditRequestCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getAuditRequestCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasAuditRequests(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasAuditRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasContactSubmissions(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasContactSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitAuditRequest(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAuditRequest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
